...
public class PassengerCheckIn {
	...
	private EachJourneyChargeNeeded journeyCharge;


	public EachJourneyChargeNeeded getJourneyCharge() {
		return journeyCharge;
	}

	public void setJourneyCharge(EachJourneyChargeNeeded journeyCharge) {
