...
public class CardExecutionServiceTest {
	...
	public void calculateEachStationStatisticsCheck() {
		...
		seniorCitizen1.setJourneyCharge(new EachJourneyChargeNeeded(0, 100));
		...
		adultCitizen1.setJourneyCharge(new EachJourneyChargeNeeded(0, 200));
		adultList.add(adultCitizen1);
		PassengerCheckIn adultCitizen2=new PassengerCheckIn("MC3", "ADULT", "CENTRAL");
		adultCitizen2.setJourneyCharge(new EachJourneyChargeNeeded(100, 100));
